...
public class RegStuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentDetailAdapter = new StudentDetailAdapter(this, new JSONArray(), "2");
    ...
    @OnClick({R.id.btn_back, R.id.main_search, R.id.btn_regsel})
