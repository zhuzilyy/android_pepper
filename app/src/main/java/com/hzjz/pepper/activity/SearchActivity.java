...
public class SearchActivity extends FragmentActivity implements OnTabSelectListener, AdSearchFragment.OnFragmentInteractionListener, ReSearchFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragments.add(AdSearchFragment.newInstance(type, param));
        mFragments.add(ReSearchFragment.newInstance(type, param));
