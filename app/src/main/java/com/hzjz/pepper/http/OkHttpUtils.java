...
public class OkHttpUtils {
     ...
     * @Description POST请求
     */
    public static void posAtsyn(String url, Map<String, String> params, HttpCallback callback) {
        Request request = OkHttpRequest.builderRequest(HttpMethodType.POST, url, params, null);
        OkHttpRequest.doEnqueue(request, callback);
    }

    public static void postJsonAsyn(String url, Map<String, String> params, HttpCallback callback) {
        Request request = OkHttpRequest.builderJsonRequest(HttpMethodType.POST, url, params);
        OkHttpRequest.doEnqueue(request, callback);
    }
    /**
     * @param url      请求地址
